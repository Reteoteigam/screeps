...
let roleBuilder = {
  ...
  run: function( creep ) {
    ...
    // prio low hp + range;
    repairSites.sort( ( a, b ) => a.hits - b.hits + a.pos.getRangeTo( creep.pos ) + 1 - b.pos.getRangeTo( creep
      .pos ) ); //speichere diese entscheitung für in paar ticks -> paar ticks
    ...
    // prio low hp + range;
    toBuilds.sort( ( a, b ) => MAPPING_STRUCTURETYPE.valueOf( a.structureType ) - MAPPING_STRUCTURETYPE.valueOf( b.structureType ) + a
      .pos.getRangeTo( creep.pos ) - b.pos.getRangeTo( creep.pos ) );
